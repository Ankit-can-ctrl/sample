...
export default function ChatHeader({ onNewChat }: ChatHeaderProps) {
  ...
  return (
    <div
      className="bg-dark text-white p-3 border-bottom border-secondary position-relative overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="d-flex align-items-center justify-content-between position-relative">
        <div className="d-flex align-items-center">
          <div className="me-3">
            <div
              className="bg-success rounded-circle d-flex align-items-center justify-content-center float"
              style={{
                width: "40px",
                height: "40px",
      ...
      {showSettings && (
        <div
          className="mt-3 p-3 bg-secondary rounded position-relative overflow-hidden"
          style={{
            background: "rgba(255, 255, 255, 0.05)",
        ...
        >
          <h6 className="text-white mb-3 fw-bold">Settings</h6>
          <div className="mb-3">
            <label className="form-label text-white small fw-bold">Model</label>
            <select
